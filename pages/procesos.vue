...
<script>
import { getUsuarios, getEstadisticas, updateCliente } from '@/services/communicationsManager.js'
...
console.log(usuarios);
    ...
    await updateCliente(this.clienteEditado.idUser, this.clienteEditado); // Asume que el ID del cliente está presente en clienteEditado
