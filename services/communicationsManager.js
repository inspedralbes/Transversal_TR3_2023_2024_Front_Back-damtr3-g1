...
export async function uploadBroadcastImg(imageFile) {
    try {
        ...
        const response = await fetch(`http://r6pixel.duckdns.org:3169/uploadBroadcast`, {
            method: 'POST',
            body: formData
        });
...
export async function editBroadcastimg(imageFile, oldImageName) {
    try {
        ...
        const response = await fetch(`http://r6pixel.duckdns.org:3169/editBroadcast`, {
            method: 'POST',
            body: formData
        });
...
export async function syncOdoo() {
    try {
        const response = await fetch(`http://r6pixel.duckdns.org:3169/syncOdoo`, {
            method: 'POST',
            headers: { 'Content-Type': 'application/json' },
        });
        const result = await response.json();
...
export async function syncOdooClient() {
    try {
        const response = await fetch(`http://r6pixel.duckdns.org:3169/syncClientOdoo
        `, {
            method: 'POST',
            headers: { 'Content-Type': 'application/json' },
        });
